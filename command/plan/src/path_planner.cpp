...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle nh_;
  ros::Publisher waypointPublisher = nh_.advertise<commond_msgs::Waypoint>("waypoint_path", 10);
  ...
  float wps[tmp * num_waypoints] =
      {
         ...
         // 0,0,            -10,0,3.0, pn2latitude(20,0),       pe2longtitude(0,0,0),
         12, 0,          -8, 0, 3.0, pn2latitude(20,0),       pe2longtitude(0,0,0),
  ...
  for (int i(0); i < num_waypoints; i++)
  {
    ...
    commond_msgs::Waypoint new_waypoint;
